...
const renderOutputSummary = ({ files, zipFileName, indexEntryPath }) => {
...
async function handleModularization() {
    ...
    try {
        ...
        const ast = acorn.parse(fileContent, { ecmaVersion: 'latest', sourceType: 'module', locations: true, allowReturnOutsideFunction: true });
        ...
        const successMsg = renderOutputSummary({ files, zipFileName, indexEntryPath });
